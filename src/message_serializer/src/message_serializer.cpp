...
std::cout << "Serial opened\n";
 ...
 uint8_t toggle_previous[2];
	    ...
	    digitalWrite(MAN_LED,HIGH);
            if (toggle_previous[0] != Drive_Man;){
               usleep(20);
            }
	    uint8_t man[6] = {127,127,127,127,127,127};
	     serial_fun(man, num_msg_elem, Drive_Man, Auto_Tel);
           }
           ...
           toggle_previous[0]=Drive_Man;
           toggle_previous[1]=Auto_Tel;
           ros::spinOnce();
           rate.sleep();
